...
{    
		...
		cout << "This program finds sum of the array elements" << endl; // вывод сообщения в консоль
		
		int arr[size_array] = {0,0,0}; // инициализируем статический массив
		...
		for (int i=0; i<size_array; i++) res_c =  res_c + arr[i]; // находим сумму элементов массива
...
start:			mov ebx, [esi] // загружаем в регистр EBX текущий элемент массива
				add eax, ebx // находим сумму элементов массива
